...
class testbase_save_to_file(unittest.TestCase):
    """unittests to test and  save_to_file method of Base class"""
...
class TestBase_from_json_string(unittest.TestCase):
    """unittest for testing files from_json_string method of Base class"""
...
class TestBase_create(unittest.TestCase):
    ...
    def test_create_square_original(self):
        ...
        s1_dictionary = Square1.to_dictionary()
...
class TestBase_load_from_file(unittest.TestCase):
    """Unittest to testing Files from  load_from_file_method of Base class."""
